    ...
    <div class="col-md-12 grid-margin">
      <div class="card border rounded">
        <div class="card-body">
          ...
          <h6 class="card-title"><span>I.</span>Update New Pin/Agri-Districty</h6>
          <br><br>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                ...
                <select class="form-control light-gray-placeholder @error('name="district"') is-invalid @enderror"  name="district" id="validationCustom01" aria-label="Floating label select e">
                    <option  value="{{$AgriDistrict->district}}">{{$AgriDistrict->district}}</option>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('arpowner_na') is-invalid @enderror" value="{{$AgriDistrict->description}}" name="description" placeholder="Enter description" value="{{ old('arpowner_na') }}">
                @error('arpowner_na')
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('latitude') is-invalid @enderror"  value="{{$AgriDistrict->latitude}}" name="latitude" id="lat" placeholder="Enter latitude" value="{{ old('latitude') }}">
                @error('latitude')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('longitude') is-invalid @enderror"value="{{$AgriDistrict->longitude}}" name="longitude" id="long" placeholder="Enter longitude" value="{{ old('longitude') }}">
                @error('longitude')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
...
function initMap() {
  var initialLocation = {lat: parseFloat('{{ $AgriDistrict->latitude }}'), lng: parseFloat('{{ $AgriDistrict->longitude }}')};
