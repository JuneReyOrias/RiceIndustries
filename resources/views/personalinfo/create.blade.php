        ...
        @endif
                    ...
                    @endif
                       ...
                       <td>
                            ...
                            <a href="{{route('personalinfo.edit_info',  $personalinformation->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                    ...
                    <td>{{ $farmprofile->date_interview}}</td>
                       ...
                       <td>
                        ...
                        <a href="{{route('fixed_cost.fixed_edit', $fixedcost->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                                    ...
                                    <td>
                                        ...
                                        @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('production_data.production_edit', $lastproductdata->id)}}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
