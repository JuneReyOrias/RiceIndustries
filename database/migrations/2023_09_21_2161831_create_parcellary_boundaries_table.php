...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('parcellary_boundaries', function (Blueprint $table) {
            ...
            $table->string('brgy_name',50)->nullable();;
            $table->string('atdn',50)->nullable();;
            $table->string('arpowner_na',50)->nullable();;
            $table->string('pkind_desc',50)->nullable();;
            $table->string('puse_desc',50)->nullable();;
            $table->string('actual_used',50)->nullable();;
            $table->string('market_value',50)->nullable();;
            $table->string('asssesedva',50)->nullable();;
            ...
            $table->string('parcolor',50)->nullable();
            $table->timestamps();
