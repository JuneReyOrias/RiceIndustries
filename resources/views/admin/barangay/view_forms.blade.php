                    ...
                    <div class="tabs">
                        ...
                        <div class="tab">
                            ...
                            <div class="modal fade" id="addBarangayModal" tabindex="-1" aria-labelledby="addBarangayModalLabel" aria-hidden="true">
                               ...
                               <div class="table-responsive">
                                <table class="table table-bordered datatable">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                        <tr>
                                            <td class="text-center" colspan="5">Barangay is empty</td>
                                        </tr>
                                        @endif
                                    </tbody>
                                </table>
                             ...
                             <!-- Pagination links -->
                             <ul class="pagination">
                                <li><a href="{{$barangays->previousPageUrl() }}">Previous</a></li>
                                @foreach ($barangays->getUrlRange(1,$barangays->lastPage()) as $page => $url)
                                    <li class="{{ $page ==$barangays->currentPage() ? 'active' : '' }}">
                                        <a href="{{ $url }}">{{ $page }}</a>
                                    </li>
                                @endforeach
                                <li><a href="{{$barangays->nextPageUrl() }}">Next</a></li>
                            </ul>
                        </div>
