...
return new class extends Migration
{
    ...
    {
        Schema::create('crops_farms', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('preferred_variety', 50)->nullable();
            $table->date('planting_schedule_wetseason')->nullable();
            $table->date('planting_schedule_dryseason')->nullable();
    ...
    {
        Schema::dropIfExists('crops_farms');
    }
};
