...
<div class="page-content">
  ...
  <div class="dropdown d-flex flex-wrap justify-content-between align-items-center">
    <h4 class="mb-3 mb-md-0 font-weight-bold">Manicahan Rice Farmers</h4>
  ...
  <div id="fixed_cost_section"class="table-section" >
      ...
      {{-- <div class="card border rounded">
          <div class="card-body"> --}}
              <h4 class="mb-3 mb-md-0">Farmers Information</h4>
              ...
              <div class="table-responsive tab">
                <table id="printTable" class="table table-bordered table-sm datatable">
                      ...
                      <tbody>
                          @foreach($FarmersData->where('agri_district','manicahan') as $personalinformation)
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 col-md-12 col-xl-5"><br>
                <h3 class="mb-2">{{ number_format($totalFixedCostAyala, 2) }}</h3>
                <div class="d-flex align-items-baseline">
                  {{-- <p class="text-success">
                    <span>+3.3%</span>
                    <i data-feather="arrow-up" class="icon-sm mb-1"></i>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 col-md-12 col-xl-5"><br>
                <h3 class="mb-2">{{ number_format($totalMachineriesUsedAyala, 2) }}</h3>
                <div class="d-flex align-items-baseline">
                  {{-- <p class="text-danger">
                    <span>-2.8%</span>
                    <i data-feather="arrow-down" class="icon-sm mb-1"></i>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 col-md-12 col-xl-5"><br>
                <h3 class="mb-1">{{ number_format($totalVariableCostAyala, 2) }}</h3>
                <div class="d-flex align-items-baseline">
                  {{-- <p class="text-success">
                    <span>+2.8%</span>
                    <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countOwner, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countOwnerTenants, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countTillerTenantTenants, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countTillerTenants, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countLeaseTenants, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5"><br>
                  <h3 class="mb-1">{{ number_format($countorg, 2) }}</h3>
                  <div class="d-flex align-items-baseline">
                    {{-- <p class="text-success">
                      <span>+2.8%</span>
                      <i data-feather="arrow-up" class="icon-sm mb-1"></i>
...
function printTableContent() {
  ...
  var description = "This table displays the Manicahan Farmers Information.";
...
function printPersonalInfo() {
  ...
  titleElement.textContent = 'Manicahan Farmers Report';
