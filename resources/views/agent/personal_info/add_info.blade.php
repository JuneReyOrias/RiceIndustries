...
<br><br>
          <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A. <span style="color:red;">Field with asterisk(*) is Required to fill up.</span></p><br>
          ...
          <form id="surveyForm" action{{url('addinfo')}} method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                <label class="form-expand" for="validationCustom01">First name:  <span style="color:red;">*</span></label>
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                <label class="form-expand" for="validationCustom02">Middle name: <span style="color:red;">*</span></label>
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                <label class="form-expand" for="validationCustom01">Last name: <span style="color:red;">*</span></label>
        ...
        <div class="col-md-3 mb-3" id="barangayInput" style="{{ in_array($agri_district, ['ayala','vitali', 'culianan', 'tumaga', 'manicahan', 'curuan']) ? 'display: block;' : 'display: none;' }}">
          <label class="form-expand" for="barangay">Barangay: <span style="color:red;">*</span></label>
          <select class="form-control" name="barangay" id="SelectBarangay">
              <!-- Options will be dynamically populated based on the selected agri_district -->
          </select>
      </div>
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Contact No.: <span style="color:red;">*</span></label>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom01">Sex: <span style="color:red;">*</span></label>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Religion: <span style="color:red;">*</span></label>
          ...
          @enderror
             ...
             {{-- add new form --}}
               ...
               {{-- add new form --}}
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="date_of_birth">Date of Birth: <span style="color:red;">*</span></label>
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Place of Birth: <span style="color:red;">*</span></label>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom01">Civil Status: <span style="color:red;">*</span> </label>
...
{{-- 
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Mother's Maiden Name: <span style="color:red;">*</label>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom01">Highest Formal Education: <span style="color:red;"></span></label>
...
{{--             
          ...
          @enderror
                  ...
                  <div class="col-md-3 mb-3" id="NoInputSelected" style="display: none;">
                    ...
                    {{-- add new form --}}
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Government Issued ID: <span style="color:red;"></span> </label>
      ...
      @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom01" style="font-size: 10px;">Member of any Farmers Ass/Org/Coop <span style="color:red;">*</span></label>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              <label class="form-expand" for="validationCustom02">Celphone/Tel.no <span style="color:red;">*</span></label>
...
function checkReligion() {
 ...
 function populateBarangays(agriDistrict) {
        ...
        switch (agriDistrict) {
            case 'ayala':
                barangays = ["Sinunuc", "Malagutay","Calarian", "Caragasan","Maasin", "Cawit","Recodo", 
                "Tulungatung","Ayala","Capisan","Tumanday","San Ramon","Talisayan"];
                break;
            case 'vitali':
                barangays = ["Taloptap", "Tindalo","Camino Nuevo,", "Tamion","Bataan","Tuktubo","Mialim","Lower Tigbao, Tictapul","Manguso","Inner Manguso","Bincul,Manguso","Sinalikway,Manguso",
                "Upper Manguso","Dungcaan,Manguso", "Tamaraan, Manguso","Licomo"];
                break;
            case 'culianan':
                barangays = ["Mercedes", "Talabaan","Culianan","Taluksangay", "Cabaluay","Guisao","Lanzones",""];
                break;
            case 'tumaga':
                barangays = ["Boalan", "Guiwan","Cabatangan","San Roque", "Santa Maria","Zambowood","Tumaga"];
                break;
            case 'manicahan':
                barangays = ["Manicahan", "Manicahan Poblacion","Manicahan B","Victoria","Sangali","Bunguiao","Bolong","Mangga Bolong"];
                break;
            case 'curuan':
                barangays = ["Curuan", "Lubigan","Dulian","Inner Quiniput","Quiniput","Ontong","Presa","Camias",
                "Bagacay","Latuan","Campilar","Sapa Manok","Sapa Moro","Mina","Calabasa","Buenavista","Muti"];
                break;
            default:
                break;
        }
