...
$requiredFields = ['first_name', 'last_name', 'middle_name', 'home_address', 'sex', 'religion', 'date_of_birth', 'place_of_birth', 'contact_no', 'civil_status', 'name_legal_spouse', 'mothers_maiden_name', 'highest_formal_education', 'government_issued_id', 'id_type', 'gov_id_no', 'member_ofany_farmers_ass_org_coop', 'nameof_farmers_ass_org_coop',];
...
$personalInformationModel = PersonalInformations::firstOrCreate([
    ...
    'date_of_birth' => Carbon::parse($personalInformation['date_of_birth'])->format('m-d-Y'),
