...
<div class="page-content">
                ...
                <h3>a. Personal Info</h3>
                     <div class="user-details">
                      <div class="input-box"  style="display: none;">
                        ...
                        <input type="hidden" class="form-control light-gray-placeholder gray-text"name="users_id" value="{{ $userId}}" placeholder="First name"value="{{ old('first_name') }}" >
                        
                      </div>      
      <div class="input-box">
        <span class="details">First Name</span>
        <input type="text" class="form-control light-gray-placeholder gray-text gray-text @error('first_name') is-invalid @enderror"value="{{ $personalinfos->first_name}}" name="first_name" placeholder="First name"value="{{ old('first_name') }}" >
        @error('first_name')
    ...
    @enderror
      ...
      <div class="input-box">
        ...
        <input type="text" class="form-control light-gray-placeholder gray-text @error('middle_name') is-invalid @enderror"value="{{ $personalinfos->middle_name}}" name="middle_name" placeholder="Middle name"value="{{ old('middle_name') }}" >
        @error('middle_name')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
      </div>
      <div class="input-box">
          ...
          <input type="text" class="form-control light-gray-placeholder gray-text @error('last_name') is-invalid @enderror"value="{{ $personalinfos->last_name}}" name="last_name" placeholder="Lastname"value="{{ old('last_name') }}" >
          @error('last_name')
          <div class="invalid-feedback">{{ $message }}</div>
      @enderror
        </div>
      <div class="input-box">
        ...
        <select class="form-control light-gray-placeholder gray-text @error('extension_name') is-invalid @enderror"  name="extension_name"id="validationCustom01" aria-label="Floating label select e">
          ...
          <option value="others" {{ old('extension_name') == 'others' ? 'selected' : '' }}>others</option>
                        ...
                        <a href="{{route('admin.farmersdata.genfarmers')}}" type="button" class="btn btn-primary" onclick="previousStep()">Previous</button></a>
                        <button type="button" class="btn btn-success" onclick="nextStep()">Next</button>
                    </div>
                    <div class="step" id="step1.2">
                      <h2>Update Personal Information</h2><br>
                        <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
                <h3>b. Contact & Demographic Info</h3>
<div class="user-details">
    <div class="input-box" style="display: none;">
    <span class="details">Country</span>
    <input type="text" class="form-control light-gray-placeholder gray-text @error('first_name') is-invalid @enderror" name="country" id="validationCustom01" value="Philippines" readonly >
    @error('first_name')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
    </div>
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text @error('last_name') is-invalid @enderror" name="province" id="validationCustom01" value="Zamboanga del sur" readonly >
    @error('last_name')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
    </div>
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text " name="city" id="validationCustom01" value="Zamboanga City" readonly >
...
<div class="input-box">
  ...
  <input type="text" name="street" id="street" class="form-control light-gray-placeholder gray-text @error('street') is-invalid @enderror"value="{{ $personalinfos->home_address}}" placeholder="home_address" autocomplete="new-password" value="{{ old('street') }}" >
  @error('street')
  <div class="invalid-feedback">{{ $message }}</div>
  @enderror
</div>
    <div class="input-box">
        ...
        <input type="text" name="street" id="street" class="form-control light-gray-placeholder gray-text @error('street') is-invalid @enderror"value="{{ $personalinfos->street}}" placeholder="Street" autocomplete="new-password" value="{{ old('street') }}" >
        @error('street')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      <div class="input-box">
        ...
        <select class="form-control light-gray-placeholder gray-text @error('zip_code') is-invalid @enderror"value="{{ $personalinfos->zip_code}}"  name="zip_code"id="validationCustom01" aria-label="Floating label select e">
    ...
    <input type="text" name="contact_no" id="contact_no" class="form-control light-gray-placeholder gray-text @error('contact_no') is-invalid @enderror"value="{{$personalinfos->contact_no}}" placeholder="Contact no." autocomplete="new-password" value="{{ old('contact_no') }}" >
    @error('contact_no')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
    </div>
    ...
    <select class="form-control light-gray-placeholder gray-text" name="sex"id="validationCustom01" aria-label="Floating label select e">
      <option value="{{ $personalinfos->sex}}">{{ $personalinfos->sex}}</option>
      <option  class="form-control light-gray-placeholder gray-text" value="male" {{ old('sex') == 'male' ? 'selected' : '' }}>Male</option>
      <option value="female" {{ old('sex') == 'female' ? 'selected' : '' }}>Female</option>
    </select>
    </div>
    <div class="input-box">
      <span class="details">Religion</span>
      <select class="form-control light-gray-placeholder gray-text" name="religion"id="validationCustom01" aria-label="Floating label select e">
    ...
    <div class="input-box">
      ...
      <input type="text" class="form-control light-gray-placeholder gray-text @error('contact_no') is-invalid @enderror"name="date_of_birth" id="datepicker" placeholder="Date of Birth" value="{{ $personalinfos->date_of_birth}}"
    ...
    <div class="input-box">
      ...
      <select class="form-control light-gray-placeholder gray-text" name="place_of_birth"id="selectplacebrth"onchange="checkPlaceBirth()"  aria-label="Floating label select e">
    ...
    <div class="input-box"id="AddBirthInput" style="display: none;">
      ...
      <input type="text"id="AddBirthInput" name="add_PlaceBirth"class="form-control light-gray-placeholder gray-text "  autocomplete="new-password" value="{{ old('add_PlaceBirth') }}" >
     
    </div>

    <div class="input-box">
      <span class="details">Civil Status</span>
      <select class="form-control light-gray-placeholder gray-text" name="civil_status" id="selectCivil" onchange="checkCivil()" aria-label="Floating label select e">
  ...
  <div class="input-box" id="MarriedInputSelected" style="display: none;">
      ...
      <input type="text" id="name_legal_spouse" name="name_legal_spouse" class="form-control light-gray-placeholder gray-text" value="{{ $personalinfos->name_legal_spouse }}" placeholder="Enter name of spouse" autocomplete="new-password" value="{{ old('name_legal_spouse') }}">
  </div>
  ...
  <div class="input-box" id="SinWidDevInput" style="display: none;">
      ...
      <select class="form-control light-gray-placeholder gray-text"  name="name_legal_spouse"id="selectFgroups"onchange="checkfarmGroup()"  aria-label="Floating label select e">
    ...
    <div class="input-box">
      ...
      <select class="form-control light-gray-placeholder gray-text" name="no_of_children"id="childrenSelect"onchange="checkChildren()" aria-label="Floating label select e">
    ...
    <div class="input-box">
      ...
      <input type="text" name="mothers_maiden_name" id="mothers_maiden_name" value="{{ $personalinfos->mothers_maiden_name}}" class="form-control light-gray-placeholder gray-text @error('mothers_maiden_name') is-invalid @enderror" placeholder="Mother's Maiden Name" autocomplete="new-password" value="{{ old('mothers_maiden_name') }}" >
    ...
    <div class="input-box">
      ...
      <select class="form-control light-gray-placeholder gray-text" name="highest_formal_education"id="selectEduc"onchange="checkFormalEduc()" aria-label="Floating label select e">
...
<div class="input-box">
  ...
  <select class="form-control light-gray-placeholder gray-text" name="person_with_disability" id="selectPWD" onchange="checkPWD()" aria-label="Floating label select e">
...
<div class="input-box" id="YesInputSelected" style="display: none;">
  ...
  <input type="text" name="pwd_id_no" id="pwd_id_no" value="{{ $personalinfos->pwd_id_no }}" class="form-control light-gray-placeholder gray-text @error('pwd_id_no') is-invalid @enderror" placeholder="Enter pwd id no" autocomplete="new-password">
  @error('pwd_id_no')
  <div class="invalid-feedback">{{ $message }}</div>
  @enderror
</div>
...
<div class="input-box" id="NoInputSelected" style="display: none;">
  <span class="details">PWD ID No</span>
  <select class="form-control light-gray-placeholder gray-text @error('pwd_id_no') is-invalid @enderror" name="pwd_id_no" id="selectFgroups" aria-label="Floating label select e">
    ...
    <div class="input-box">
      ...
      <select class="form-control light-gray-placeholder gray-text @error('government_issued_id') is-invalid @enderror"  name="government_issued_id"id="selectGov"onchange="CheckGoverniD()" aria-label="Floating label select e">
    ...
    <div class="input-box" id="iDtypeSelected" style="display: none;">
      ...
      <select class="form-control light-gray-placeholder gray-text @error('id_type') is-invalid @enderror" name="id_type"id="selectIDType"onchange="checkIDtype()" aria-label="Floating label select e">
    ...
    <div class="input-box"  id="idNoInput" style="display: none;">
      ...
      <input type="text" name="add_Idtype" id="add_Idtype"value="{{ $personalinfos->gov_id_no}}" class="form-control light-gray-placeholder gray-text @error('add_Idtype') is-invalid @enderror" placeholder="gov. id no" autocomplete="new-password" value="{{ old('add_Idtype') }}" >
      @error('add_Idtype')
      <div class="invalid-feedback">{{ $message }}</div>
      @enderror
    </div>
    ...
    <div class="input-box"  id="NoSelected" style="display: none;">
      ...
      <input type="text" name="id_types" id="id_types" class="form-control light-gray-placeholder gray-text @error('id_types') is-invalid @enderror" placeholder="non-gov id" autocomplete="new-password" value="{{ old('id_types') }}" >
      @error('id_types')
      <div class="invalid-feedback">{{ $message }}</div>
      @enderror
    </div>
...
<div class="input-box">
  <span class="details">Member of any Farmers Ass/Org/Coop</span>
  <select class="form-control light-gray-placeholder gray-text @error('member_ofany_farmers_ass_org_coop') is-invalid @enderror" id="selectMember" onchange="checkMmbership()" name="member_ofany_farmers_ass_org_coop" aria-label="Floating label select e">
      <option value="1" {{ $personalinfos->member_ofany_farmers_ass_org_coop == 1 ? 'selected' : '' }}>Yes</option>
      <option value="0" {{ $personalinfos->member_ofany_farmers_ass_org_coop == 0 ? 'selected' : '' }}>No</option>
  </select>
  @error('member_ofany_farmers_ass_org_coop')
...
<div class="input-box" id="YesFarmersGroup" style="display: none;">
  ...
  <div class="input-box" id="newFarmerGroupInput" style="display: none;">
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text @error('add_FarmersGroup') is-invalid @enderror" name="add_FarmersGroup" placeholder="Add farmers org/assoc/Coop"value="{{ old('add_FarmersGroup') }}" >
...
<div class="input-box">
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text @error('name_contact_person') is-invalid @enderror"value="{{ $personalinfos->name_contact_person}}" name="name_contact_person" placeholder="Enter your lastname"value="{{ old('name_contact_person') }}" >
...
@enderror
  ...
  <div class="input-box">
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text @error('cp_tel_no') is-invalid @enderror"value="{{ $personalinfos->cp_tel_no}}" name="cp_tel_no" placeholder="Enter your lastname"value="{{ old('cp_tel_no') }}" >
    @error('cp_tel_no')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
  </div>
  <div class="input-box">
    ...
    <input type="text" class="form-control light-gray-placeholder gray-text @error('contact_no') is-invalid @enderror"value="{{ $personalinfos->date_interview}}" name="date_interview" id="datepicker" placeholder="Date of interview"
    value="{{ old('date_of_birth') }}" data-input='true'> 
    @error('contact_no')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
