...
<div class="page-content">
    ...
    <div class="card-forms border rounded">
        ...
        <div class="card-forms border rounded">
            ...
            <div class="content">
            <form id="multi-step-form" action{{url('saveFarmerOrg')}} method="post">
                @csrf
                <div >
...
<br><br>
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                          ...
                          <input type="text" class="form-control light-gray-placeholder @error('org_name') is-invalid @enderror"  name="org_name"id="selectReligion"onchange="checkReligion()" >
                          @error('org_name')
                          <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                        </div>
