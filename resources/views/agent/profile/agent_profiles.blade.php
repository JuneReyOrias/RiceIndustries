          ...
          <div class="card-body">
            <form action{{ url('Agentupdate') }} method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="first_name" autocomplete="off" value="{{$agent->first_name}}">
                </div>
              </div>
              <hr>
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="last_name" autocomplete="off" value="{{$agent->last_name}}">
                </div>
              </div>
              <hr>
              <div class="row">
